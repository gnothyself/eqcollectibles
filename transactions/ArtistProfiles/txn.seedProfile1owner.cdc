...
transaction(artistId: UInt64) {
  prepare(auth: AuthAccount){
    ...
    let admin = auth.borrow<&EQArtists.Admin>(from: EQArtists.AdminStoragePath)!
    // let adminProfile = admin.borrowProfile(artistId: artistId) ?? panic("This admin does not possess a Primary Resrouce for this artist")
   
   //create collectibles
    admin.createCollectibleTemplate( //templateId 1 
      artistId: artistId,
      name: "Rapta-bot", 
    ...
    //create icons
    admin.createIconTemplate( //templateId 3
      artistId: artistId,
      name: "Rapta Icon", 
    ...
    //create accessories
    admin.createAccessoryTemplate( //templateId 5 
      artistId: artistId,
    ...
    admin.createAccessoryTemplate( //templateId 6
      artistId: artistId,
    ...
    admin.createAccessoryTemplate( //templateId 7
      artistId: artistId,
    ...
    let profile = EQArtists.borrowProfile(artistId: 1)!
